...
[![Docker Automated build](https://img.shields.io/docker/automated/brentwg/docker-centos6-ansible.svg?maxAge=2592000)](https://hub.docker.com/r/brentwg/docker-centos6-ansible/)

CentOS 6 Docker container for Ansible playbook and role testing. Everything which follows borrows *extensively* from the wise examples of Jeff Geerling. He is an amazing teacher. Look him up someday.
...
```
docker pull brentwg/docker-centos6-ansible:latest
```  
...
```
docker run --detach --privileged --volume=/sys/fs/cgroup:/sys/fs/cgroup:ro brentwg/docker-centos6-ansible:latest /lib/systemd/systemd
```  
